...
const App = () => {
  ...
  return (
    <form action={values.actionUrl} method="post" target="_blank" className="flex-columns-container height-fill">
      ...
      <div className="form-group">
        <label htmlFor="email" className="form-label">{values.label3}</label>
        <input id="email" type="email" className="form-control" name="email" placeholder="example@contoso.com"
          defaultValue={defaultEmail} />
      </div>
      <div className="form-group">
        <label htmlFor="email" className="form-label">{values.label4}</label>
        <input id="email" type="email" className="form-control" name="email" placeholder="example@contoso.com"
          defaultValue={defaultEmail} />
      </div>
      <div className="form-group">
        <label htmlFor="email" className="form-label">{values.label5}</label>
        <input id="email" type="email" className="form-control" name="email" placeholder="example@contoso.com"
          defaultValue={defaultEmail} />
      </div>
      <div className="form-group">
